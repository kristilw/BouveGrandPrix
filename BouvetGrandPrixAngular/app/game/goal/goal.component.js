...
var GoalComponent = (function () {
    ...
    GoalComponent.prototype.ngOnChanges = function () {
        ...
        var milliseconds_string = (Math.floor((this.completionTime * 100 % 100))).toString();
        if (milliseconds_string.length === 1)
            milliseconds_string = "0" + milliseconds_string;
        var seconds_string = (Math.floor((this.completionTime % 60))).toString();
        if (seconds_string.length === 1)
            seconds_string = "0" + seconds_string;
        var minute_string = (Math.floor((this.completionTime / 60))).toString();
