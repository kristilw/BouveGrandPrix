...
export class GameComponent {
    ...
    car_speed: number = 0;
    car_maxAcceleration: number = 16;
    car_grip: number = 500;
    minimumSpeedLimit: number = 13;
    ...
    speedometer_maxSpeed: number = 70;
    ...
    updateSpeedometer(speed: number): void {
        if (this.speedometer_needle_img_loaded) {
            let angle: number = Math.PI/180*(speed/this.speedometer_maxSpeed*120 - 62);
