...
var GameComponent = (function () {
    function GameComponent(route, router) {
        ...
        this.car_resistance_square = 0.0010;
        this.car_resistance_linear = 0.1;
        this.car_img_id = 0;
        this.car_speed = 0;
        this.car_maxAcceleration = 30;
        this.car_grip = 1200;
        this.minimumSpeedLimit = 30;
    ...
    GameComponent.prototype.handleAcceleration = function (actualFrameTime_milli) {
        ...
        this.keysPressed.forEach(function (item, key, mapObj) {
            if (item === true) {
                var keyPressed = _this.keyToEvent.get(key).trim();
                ...
                if (keyPressed === "accelerate") {
                    ...
                    car_speed_delta = -_this.car_maxAcceleration * actualFrameTime_milli / 1000 * 2;
                }
